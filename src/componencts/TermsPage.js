...
const TermsPage = () => {
	...
	return (
		<div className="container">
			<div className="terms__title">{t("terms.title")}</div>
			<div className="terms">

				<p>Version 1.0</p>

				<p>The Youtube Downloader website located at {window.location.origin} is a copyrighted work belonging to Youtube Downloader. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
				...
				<p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Address. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
				...
				<p><strong>Your Privacy.</strong> Please read our <Link to="/privacy">Privacy Policy</Link>.</p>
				...
				<p>Visit our <Link to="/contact" >Contact Us</Link> page</p>
			</div>
		</div>
	)
}
